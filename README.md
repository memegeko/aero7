...
The SDL launcher uses smooth scaling, disables QEMU's conflicting VMware mouse,
and uses a native VirtIO tablet so pointer coordinates and click events remain
aligned with the installer framebuffer.
