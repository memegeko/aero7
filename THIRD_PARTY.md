...
| PlymouthVista software | MIT; the retained upstream light-orb frames keep their original notice, while the reveal and branding frames are Aero7 project artwork |
...
- On 2026-08-09 the project owner approved continued Beta use of PlymouthVista
  based on the MIT license distributed by that repository. This records the
  project's release decision, not legal advice or a claim that Microsoft
  authorized or endorsed the visual resources attributed to it upstream.
...
release screenshot pass. PlymouthVista is a separate requested compatibility
theme distributed with an MIT license and an upstream Microsoft-asset
attribution. Both notices are preserved. The project makes no Microsoft
